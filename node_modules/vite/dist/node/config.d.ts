...
import { CompilerOptions, SFCStyleCompileOptions, SFCAsyncStyleCompileOptions } from '@vue/compiler-sfc';
...
export declare type CssPreprocessOptions = Record<PreprocessLang, PreprocessOptions>;
...
export interface Plugin extends Pick<UserConfig, 'alias' | 'transforms' | 'resolvers' | 'configureServer' | 'vueCompilerOptions' | 'vueCustomBlockTransforms' | 'rollupInputOptions' | 'rollupOutputOptions' | 'enableRollupPluginVue'> {
}

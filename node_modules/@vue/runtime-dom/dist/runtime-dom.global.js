var VueRuntimeDOM = (function (exports) {
  ...
  */
  ...
  function initApp(app, version) {
      ...
      if (!exports.devtools)
          return;
      exports.devtools.emit(DevtoolsHooks.APP_INIT, app, version, {
          Fragment: Fragment,
          Text: Text,
          Comment: Comment,
          Static: Static
  ...
  function appUnmounted(app) {
      if (!exports.devtools)
          return;
      exports.devtools.emit(DevtoolsHooks.APP_UNMOUNT, app);
  }
  ...
  function createDevtoolsHook(hook) {
      return (component) => {
          if (!exports.devtools || !component.appContext.__app)
              return;
          exports.devtools.emit(hook, component.appContext.__app, component.uid, component.parent ? component.parent.uid : undefined);
      };
  }

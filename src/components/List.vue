<template>
    <div class="contaienr">
        <form>
            <label for="name">
                name: <input type="text" v-log:name-action.focuss="form.name" v-model="form.name">
            </label>
        </form>
        <h2>{{ form.name }}</h2>
        <button @click="dataInit">click</button>
...
<script>
import { defineComponent, ref, reactive, watchEffect, watch, computed, onMounted } from 'vue'
